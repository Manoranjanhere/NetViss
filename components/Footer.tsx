...
export function Footer() {
  return (
    <footer className="relative overflow-hidden bg-[#0c1730] py-16 text-white">
      ...
      <div className="relative mx-auto flex max-w-7xl flex-col items-start justify-between gap-10 px-5 sm:px-8 lg:flex-row lg:items-center">
        <div>
      ...
      <p className="relative mx-auto mt-10 max-w-7xl px-5 text-xs text-slate-500 sm:px-8">
